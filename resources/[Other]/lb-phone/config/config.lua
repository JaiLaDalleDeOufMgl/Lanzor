...
Config.Companies.Services = {
    ...
    },
    {
        job = "avocat",
        name = "Cabinet Avocat",
        icon = "https://cdn-icons-png.flaticon.com/512/3611/3611319.png",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
    ...
    },
    {
        job = "tequilala",
        name = "Tequilala",
        icon = "https://cdn-icons-png.flaticon.com/512/4860/4860603.png",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
        bossRanks = {"boss"}, -- ranks that can manage the company
        location = {
    ...
    },
    {
        job = "mecano2",
        name = "LS Custom",
        icon = "https://cdn-icons-png.flaticon.com/128/814/814406.png",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
        bossRanks = {"boss"}, -- ranks that can manage the company
        location = {
    ...
    },
    {
        job = "unicorn",
        name = "Unicorn",
        icon = "https://cdn-icons-png.flaticon.com/128/9300/9300748.png",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
        bossRanks = {"boss"}, -- ranks that can manage the company
        location = {
    ...
    },
    {
        job = "burgershot",
        name = "Burger Shot",
        icon = "https://cdn-icons-png.flaticon.com/128/877/877951.png",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
        bossRanks = {"boss"}, -- ranks that can manage the company
        location = {
    ...
    },
    {
        job = "bahamas",
        name = "Malibu Disco",
        icon = "https://cdn-icons-png.flaticon.com/128/3086/3086535.png",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
        bossRanks = {"boss"}, -- ranks that can manage the company
        location = {
    ...
    },
    {
        job = "gouv",
        name = "Gouvernement",
        icon = "https://cdn-icons-png.flaticon.com/512/4797/4797110.png",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
        bossRanks = {"boss"}, -- ranks that can manage the company
        location = {
