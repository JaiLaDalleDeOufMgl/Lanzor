...
function IsURLWhitelisted(URL){
    ...
    for(var i = 0; i < app.whitelist.length; i++){
        var whitelistURL = app.whitelist[i];
...
var app = new Vue({
    ...
    methods: {
        play: function (song) {
            if(!IsURLWhitelisted(song.url)){
                sendAlert(locales.nonWhitelisted, 'danger')
                return;
            }
