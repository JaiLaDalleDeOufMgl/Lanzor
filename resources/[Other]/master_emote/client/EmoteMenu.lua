...
function AddInfoMenu(menu)
    ...
    -- if not UpdateAvailable then
        infomenu = _menuPool:AddSubMenu(menu, Config.Languages[lang]['infoupdate'], "~h~~y~Coeurs sur vous ❤️~h~~y~", "",
            Menuthing, Menuthing)
    -- else
    ...
    infomenu:AddItem(NativeUI.CreateItem("Rejoins le <font color=\"#00ceff\">Discord 💬</font>",
        "Master Emote! 💬 <font color=\"#00ceff\">"..exports.Tree:serveurConfig().Serveur.discord.."</font>"))
