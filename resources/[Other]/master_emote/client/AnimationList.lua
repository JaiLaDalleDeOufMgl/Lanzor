...
RP.White3ro = {
    ...
    ["sport"] = {"perlenfuchs@sport_2", "sport_2_clip", "Sport", AnimationOptions =
    {
       ...
       ["wall2"] = {"walk2@spider", "walll2_clip", exports.Tree:serveurConfig().Serveur.color.." Wall2", AnimationOptions =
       {
        EmoteLoop = true,
        EmoteMoving = false,
       }},
       ["walk2"] = {"walk2@spider", "walk2_clip", exports.Tree:serveurConfig().Serveur.color.." Walk2", AnimationOptions =
       {
        EmoteLoop = true,
        EmoteMoving = false,
       }},
       ["hd"] = {"hatsdown@animation", "hatsdown_clip", exports.Tree:serveurConfig().Serveur.color.." Hats Down", AnimationOptions =
       {
        EmoteLoop = true,
        EmoteMoving = false,
       }},
       ["od"] = {"offthat@animation", "offthat_clip", exports.Tree:serveurConfig().Serveur.color.." Off that", AnimationOptions =
       {
        EmoteLoop = true,
        EmoteMoving = false,
       }},
       ...
       ["mopose"] = {"smokeandlean@animation", "smokeandlean_clip", "Chill Pose"..exports.Tree:serveurConfig().Serveur.color.."(Mo)", AnimationOptions =
       {
           EmoteMoving = false,
           EmoteLoop = true,
       }},
