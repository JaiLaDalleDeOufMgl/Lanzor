Config.Languages = {
    ['pt'] = { -- Brazilian Portuguese 🇧🇷
        ['emotes'] = 'Emotes 🎬',
        ['whitecustom'] = exports.Tree:serveurConfig().Serveur.color..'Master Emotes 3.0~w~',
        ['whitecustom2do'] = exports.Tree:serveurConfig().Serveur.color..'Master Emotes 4.0~w~',
        ['whitecustom5to'] = exports.Tree:serveurConfig().Serveur.color..'Master Emotes 5.0~w~',
        ...
        ['cancelemoteinfo'] = exports.Tree:serveurConfig().Serveur.color.."X~w~ Cancela os emotes rodando atualmente",
        ...
        ['infoupdateavtext'] = "Uma atualização disponível, veja https://discord.gg/ para pegar",
        ['suggestions'] = "Sugestões?",
        ['suggestionsinfo'] = exports.Tree:serveurConfig().Serveur.color.."WC~s~ no fórum do FiveM para qualquer sugestão de recurso/emotes! ✉️",
        ...
        ['nobodyclose'] = "Ninguém próximo o "..exports.Tree:serveurConfig().Serveur.color.."suficiente~w~.",
        ['doyouwanna'] = "~y~Y~w~ para aceitar, "..exports.Tree:serveurConfig().Serveur.color.."L~w~ para recusar (~g~",
        ...
        ['searchmenudesc'] = "%s resultado(s) para '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~':",
        ['searchnoresult'] = "Nenhum resultado para a pesquisa '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~'.",
     ...
     ['zhcn'] = { -- Chinese simplified
        ...
        ['cancelemote'] = "取消动作 🚷",
        ['cancelemoteinfo'] = exports.Tree:serveurConfig().Serveur.color.."X~w~ 取消当前动作",
        ...
        ['suggestions'] = "想提出建议？",
        ['suggestionsinfo'] = "请在 FiveM 论坛上联系 "..exports.Tree:serveurConfig().Serveur.color.."WC~s~ 提出功能 / 动作建议！ ✉️",
        ...
        ['nobodyclose'] = "没有人 "..exports.Tree:serveurConfig().Serveur.color.."靠近~w~。",
        ['doyouwanna'] = "按 ~y~Y~w~ 接受，按 "..exports.Tree:serveurConfig().Serveur.color.."L~w~ 拒绝 (~g~",
        ['refuseemote'] = "已拒绝动作。",
        ['makenearby'] = "让附近的玩家播放",
        ...
        ['searchemotes'] = "🔍 搜索动作",
        ['searchinputtitle'] = "搜索:",
        ['searchmenudesc'] = "'"..exports.Tree:serveurConfig().Serveur.color.."%s~w~' 有 %s 个结果：",
        ['searchnoresult'] = "'"..exports.Tree:serveurConfig().Serveur.color.."%s~w~' 没有搜索结果。",
    ...
    ['zhtw'] = { -- Chinese Traditional
        ...
        ['cancelemote'] = "取消動作 🚷",
        ['cancelemoteinfo'] = exports.Tree:serveurConfig().Serveur.color.."X~w~ 取消當前動作",
        ...
        ['suggestions'] = "想提出建議？",
        ['suggestionsinfo'] = "請在 FiveM 論壇上聯系 "..exports.Tree:serveurConfig().Serveur.color.."WC~s~ 提出功能 / 動作建議！ ✉️",
        ...
        ['nobodyclose'] = "沒有人 "..exports.Tree:serveurConfig().Serveur.color.."靠近~w~。",
        ['doyouwanna'] = "按 ~y~Y~w~ 接受，按 "..exports.Tree:serveurConfig().Serveur.color.."L~w~ 拒絕 (~g~",
        ['refuseemote'] = "已拒絕動作。",
        ['makenearby'] = "讓附近的玩家播放",
        ...
        ['searchemotes'] = "🔍 搜索動作",
        ['searchinputtitle'] = "搜索:",
        ['searchmenudesc'] = "'"..exports.Tree:serveurConfig().Serveur.color.."%s~w~' 有 %s 個結果：",
        ['searchnoresult'] = "'"..exports.Tree:serveurConfig().Serveur.color.."%s~w~' 沒有搜索結果。",
    ...
    ['cs'] = { -- Czech 🇨🇿
        ...
        ['cancelemoteinfo'] = exports.Tree:serveurConfig().Serveur.color.."X~w~ Zruší aktuálně přehrávanou animaci",
        ...
        ['suggestions'] = "Nápady?",
        ['suggestionsinfo'] = exports.Tree:serveurConfig().Serveur.color.."WC~s~ na FiveM forums je pro jakýkoliv návrh! ✉️",
        ...
        ['nobodyclose'] = "Nikdo "..exports.Tree:serveurConfig().Serveur.color.."není~w~ v dostatečné blízkosti.",
        ['doyouwanna'] = "~y~Y~w~ pro příjmutí, "..exports.Tree:serveurConfig().Serveur.color.."L~w~ pro odmitnutí (~g~",
        ...
        ['searchmenudesc'] = "%s výsledek pro '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~':",
        ['searchnoresult'] = "Žádna animace nebyla nalezena '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~'.",
    ...
    ['da'] = { -- Danish 🇩🇰
        ...
        ['cancelemoteinfo'] = exports.Tree:serveurConfig().Serveur.color.."X~w~ annullerer din igangværende animation.",
        ...
        ['suggestions'] = "Forslag?",
        ['suggestionsinfo'] = exports.Tree:serveurConfig().Serveur.color.."WC~s~ på FiveM-forum for alle funktioner/emote-forslag! ✉️",
        ...
        ['nobodyclose'] = "Ingen "..exports.Tree:serveurConfig().Serveur.color.."personer~w~ i nærheden.",
        ['doyouwanna'] = "~y~Y~w~ for at acceptere, "..exports.Tree:serveurConfig().Serveur.color.."L~w~ for at afvist (~g~",
        ...
        ['searchmenudesc'] = "%s resultat(er) for '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~':",
        ['searchnoresult'] = "Ingen resultater fundet med '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~'.",
    ...
    ['nl'] = { -- Dutch 🇳🇱
        ...
        ['cancelemoteinfo'] = exports.Tree:serveurConfig().Serveur.color.."X~w~ Stopt je huidige animatie",
        ...
        ['suggestionsinfo'] = exports.Tree:serveurConfig().Serveur.color.."WC~s~ op de FiveM forums om suggesties in te dienen! ✉️",
        ...
        ['nobodyclose'] = "Er is niemand "..exports.Tree:serveurConfig().Serveur.color.."dichtbij~w~ genoeg.",
        ['doyouwanna'] = "~y~Y~w~ om te accepteren, "..exports.Tree:serveurConfig().Serveur.color.."L~w~ om te weigeren (~g~",
        ...
        ['searchmenudesc'] = "%s Resultaat(s) voor'"..exports.Tree:serveurConfig().Serveur.color.."%s~w~':",
        ['searchnoresult'] = "Geen resultaat voor zoekopdracht '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~'.",
    ...
    ['en'] = { -- English 🇬🇧
        ...
        ['cancelemoteinfo'] = exports.Tree:serveurConfig().Serveur.color.."X~w~ Cancels the currently playing emote",
        ...
        ['suggestionsinfo'] = exports.Tree:serveurConfig().Serveur.color.."WC~s~ on FiveM forums for any feature/emote suggestions! ✉️",
        ...
        ['nobodyclose'] = "Nobody "..exports.Tree:serveurConfig().Serveur.color.."close~w~ enough.",
        ['doyouwanna'] = "~y~Y~w~ to accept, "..exports.Tree:serveurConfig().Serveur.color.."L~w~ to refuse (~g~",
        ...
        ['searchmenudesc'] = "%s result(s) for '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~':",
        ['searchnoresult'] = "No results for search '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~'.",
    ...
    ['fi'] = { -- Finnish 🇫🇮
        ...
        ['cancelemoteinfo'] = exports.Tree:serveurConfig().Serveur.color.."X~w~ Peruu tämän hetkisen animaation",
        ...
        ['suggestionsinfo'] = exports.Tree:serveurConfig().Serveur.color.."WC~s~ FiveM foorumeilla liittyen mihin tahansa ominaisuus/animaatio ehdotukseen! ✉️",
        ...
        ['nobodyclose'] = "Kukaan ei ole "..exports.Tree:serveurConfig().Serveur.color.."lähelläsi~w~.",
        ['doyouwanna'] = "~y~Y~w~ hyväksyäksesi, "..exports.Tree:serveurConfig().Serveur.color.."L~w~ kieltäytyäksesi (~g~",
        ...
        ['searchmenudesc'] = "%s tulokset '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~':",
        ['searchnoresult'] = "Ei tuloksia haulle '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~'.",
    ...
    ['fr'] = { -- French 🇫🇷
        ...
        ['whitecustom'] = '💜 Emotes 1.0~w~',
        ['whitecustom2do'] = '💜 Emotes 2.0~w~',
        ['whitecustom5to'] = '💜 Emotes 3.0~w~',
        ...
        ['cancelemoteinfo'] = exports.Tree:serveurConfig().Serveur.color.."X~w~ Annule l'emote en cours",
        ...
        ['suggestions'] = "Suggestions?",
        ['suggestionsinfo'] = exports.Tree:serveurConfig().Serveur.color.."WC~s~ sur les forums FiveM pour toutes les suggestions! ✉️",
        ...
        ['doyouwanna'] = "~y~Y~w~ accepter, "..exports.Tree:serveurConfig().Serveur.color.."L~w~ refuser (~g~",
        ...
        ['searchmenudesc'] = "%s resultat(s) pour '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~':",
        ['searchnoresult'] = "Aucun résultat pour la recherche : '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~'.",
    ...
    ['de'] = { -- German 🇩🇪
        ...
        ['cancelemoteinfo'] = exports.Tree:serveurConfig().Serveur.color.." X ~w~ Bricht das aktuell wiedergegebene Emote ab",
        ...
        ['suggestionsinfo'] = exports.Tree:serveurConfig().Serveur.color.."WC~s~ in FiveM-Foren für alle Feature- / Emote-Vorschläge! ✉️",
        ...
        ['doyouwanna'] = "~y~Z~w~ zu akzeptieren, "..exports.Tree:serveurConfig().Serveur.color.."L~w~ zu verweigern (~g~",
        ...
        ['searchmenudesc'] = "%s Ergebnis(se) für '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~':",
        ['searchnoresult'] = "Es wurden keine Ergebnisse gefunden für '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~'.",
    ...
    ['hu'] = { -- Hungarian 🇭🇺
        ...
        ['cancelemoteinfo'] = exports.Tree:serveurConfig().Serveur.color.."X~w~ Megszünteti az aktuálisan lejátszott animációt",
        ...
        ['suggestionsinfo'] = exports.Tree:serveurConfig().Serveur.color.."WC~s~ a FiveM fórumokon bármilyen funkcióra/animációra vonatkozó javaslatért! ✉️",
        ...
        ['nobodyclose'] = "Senki sincs elég "..exports.Tree:serveurConfig().Serveur.color.."közel~w~.",
        ['doyouwanna'] = "~y~Y~w~ gomb az elfogadáshoz, "..exports.Tree:serveurConfig().Serveur.color.."L~w~ gomb az elutasításhoz (~g~",
        ...
        ['searchmenudesc'] = "%s eredmény erre: '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~':",
        ['searchnoresult'] = "Nincs eredmény erre: '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~'.",
    ...
    ['it'] = { -- Italian 🇮🇹
        ...
        ['cancelemoteinfo'] = exports.Tree:serveurConfig().Serveur.color.."X~w~ Cancella l'animazione in corso.",
        ...
        ['suggestionsinfo'] = exports.Tree:serveurConfig().Serveur.color.."WC~s~ nei forum di FiveM per suggerimenti su funzionalitá/animazioni! ✉️",
        ...
        ['nobodyclose'] = "Nessun giocatore abbastanza "..exports.Tree:serveurConfig().Serveur.color.."vicino~w~.",
        ['doyouwanna'] = "~y~Y~w~ per accettare, "..exports.Tree:serveurConfig().Serveur.color.."L~w~ per rifiutare (~g~",
	...
	['no'] = { -- Norwegian 🇳🇴
        ...
        ['cancelemoteinfo'] = exports.Tree:serveurConfig().Serveur.color.."X~w~ Avbryt den nåværende animasjonen",
        ...
        ['suggestions'] = "Forslag?",
        ['suggestionsinfo'] = exports.Tree:serveurConfig().Serveur.color.."WC~s~ på FiveM forumet vist du har forslag til forbedringer/ animasjoner! ✉️",
        ['notvaliddance'] = "er ikke en gyldig dans.",
        ['emotemenucmd'] = "Use command /emotemenu to open animations menu.",
        ...
        ['nobodyclose'] = "Ingen "..exports.Tree:serveurConfig().Serveur.color.."personer~w~ er i nærheten.",
        ['doyouwanna'] = "~y~Y~w~ for å akseptere, "..exports.Tree:serveurConfig().Serveur.color.."L~w~ for å avvise (~g~",
        ...
        ['searchmenudesc'] = "%s resultat(er) for '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~':",
        ['searchnoresult'] = "Ingen resultater for søk '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~'.",
	...
	['fa'] = { -- persian 🇮🇷
        ...
        ['cancelemoteinfo'] = exports.Tree:serveurConfig().Serveur.color.."X~w~ baray laghv emote ",
        ...
        ['nobodyclose'] = "hichkas nist "..exports.Tree:serveurConfig().Serveur.color.."bastan~w~ kafi nist.",
        ['doyouwanna'] = "~y~Y~w~ baray ghabol, "..exports.Tree:serveurConfig().Serveur.color.."L~w~ baray rad kardan  (~g~",
    ...
    ['pl'] = { -- Polish 🇵🇱
        ...
        ['cancelemoteinfo'] = exports.Tree:serveurConfig().Serveur.color.."X~w~ Anuluje aktualnie graną animację",
        ...
        ['suggestionsinfo'] = "Napisz do "..exports.Tree:serveurConfig().Serveur.color.."WC~s~ na forum FiveMa odnośnie przyszłych ficzerów czy propozycji! ✉️",
        ...
        ['nobodyclose'] = "Nie ma nikogo "..exports.Tree:serveurConfig().Serveur.color.."w pobliżu~w~.",
        ['doyouwanna'] = "~y~Y~w~ by zaakceptować, "..exports.Tree:serveurConfig().Serveur.color.."L~w~ by odrzucić (~g~",
        ...
        ['searchmenudesc'] = "%s wyników dla frazy '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~':",
        ['searchnoresult'] = "Brak wyników dla frazy '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~'.",
    ...
    ['ro'] = { -- Romanian 🇷🇴
        ...
        ['cancelemoteinfo'] = exports.Tree:serveurConfig().Serveur.color.."X~w~ Anuleaza animatia curenta",
        ...
        ['suggestionsinfo'] = exports.Tree:serveurConfig().Serveur.color.."WC~s~ pe forumurile FiveM pentru orice sugestie de feature/emote nou! ✉️",
        ...
        ['nobodyclose'] = "Nu este nici o persoana "..exports.Tree:serveurConfig().Serveur.color.."langa tine~w~.",
        ['doyouwanna'] = "~y~Y~w~ pentru a accepta, "..exports.Tree:serveurConfig().Serveur.color.."L~w~ pentru a refuza (~g~",
        ...
        ['searchmenudesc'] = "%s rezultat(e) pentru '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~':",
        ['searchnoresult'] = "Fara rezultate pentru cautarea '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~'.",
    ...
    ['ru'] = { -- Russian 🇷🇺
        ...
        ['cancelemoteinfo'] = exports.Tree:serveurConfig().Serveur.color.."X~w~ Отменяет воспроизводимую эмоцию",
        ...
        ['suggestionsinfo'] = exports.Tree:serveurConfig().Serveur.color.."WC~s~ на форумах FiveM для любых предложений по функциям/эмоциям! ✉️",
        ...
        ['nobodyclose'] = "Никого "..exports.Tree:serveurConfig().Serveur.color.."close~w~ нет поблизости.",
        ['doyouwanna'] = "~y~Y~w~ для принятия, "..exports.Tree:serveurConfig().Serveur.color.."L~w~ для отмены (~g~",
        ...
        ['searchmenudesc'] = "%s результат(ы) для '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~':",
        ['searchnoresult'] = "Нет результатов по поиску '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~'.",
    ...
    ['lk'] = { -- Sinhala 🇱🇰
        ...
        ['cancelemoteinfo'] = exports.Tree:serveurConfig().Serveur.color.."X~w~ Wetila thiyana emote eka nawattanawa",
        ...
        ['nobodyclose'] = "Kawruwat "..exports.Tree:serveurConfig().Serveur.color.."Laga~w~ na.",
        ['doyouwanna'] = "~y~Y~w~ accept karanna, "..exports.Tree:serveurConfig().Serveur.color.."L~w~ decline karanna (~g~",
        ...
        ['searchmenudesc'] = "%s result(s) for '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~':",
        ['searchnoresult'] = "Mukut hambune na '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~'.",
    ...
    ['es'] = { -- Spanish 🇪🇸
        ...
        ['cancelemoteinfo'] = exports.Tree:serveurConfig().Serveur.color.."X~w~ Cancela la animación actual.",
        ...
        ['suggestionsinfo'] = exports.Tree:serveurConfig().Serveur.color.."WC~s~ en el foro de FiveM para cualquier sugerencia! ✉️",
        ...
        ['nobodyclose'] = "Nadie "..exports.Tree:serveurConfig().Serveur.color.."cerca~w~.",
        ['doyouwanna'] = "~y~Y~w~ para aceptar, "..exports.Tree:serveurConfig().Serveur.color.."L~w~ para rechazar (~g~",
        ...
        ['searchmenudesc'] = "%s resultado(s) para '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~':",
        ['searchnoresult'] = "No se encontró nada con '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~'.",
    ...
    ['sv'] = { -- Swedish 🇸🇪
        ...
        ['cancelemoteinfo'] = exports.Tree:serveurConfig().Serveur.color.."X~w~ avbryter nuvarande spelande emote.",
        ...
        ['suggestions'] = "Förslag?",
        ['suggestionsinfo'] = exports.Tree:serveurConfig().Serveur.color.."WC~s~ på FiveM-forum för förslag på funktioner/emotes! ✉️",
        ...
        ['nobodyclose'] = "Ingen "..exports.Tree:serveurConfig().Serveur.color.."närliggande~w~ person hittades.",
        ['doyouwanna'] = "~y~Y~w~ för att acceptera, "..exports.Tree:serveurConfig().Serveur.color.."L~w~ för att avböja (~g~",
        ...
        ['searchmenudesc'] = "%s resultat på '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~':",
        ['searchnoresult'] = "Inga resultat hittades på '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~'.",
    ...
    ['tr'] = { -- Turkish 🇹🇷
        ...
        ['cancelemoteinfo'] = exports.Tree:serveurConfig().Serveur.color.."X~w~ Oynamakta olan ifadeyi iptal eder",
        ...
        ['nobodyclose'] = "Kimse yeterince "..exports.Tree:serveurConfig().Serveur.color.."yakın~w~ değil.",
        ['doyouwanna'] = "~y~Y~w~ to accept, "..exports.Tree:serveurConfig().Serveur.color.."L~w~ to refuse (~g~",
        ...
        ['searchmenudesc'] = "%s için sonuç(lar) '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~':",
        ['searchnoresult'] = "'"..exports.Tree:serveurConfig().Serveur.color.."%s~w~' Arama sonucu bulunamadı.",
    ...
    ['vi'] = { -- Tiếng việt
        ...
        ['cancelemoteinfo'] = exports.Tree:serveurConfig().Serveur.color.."X~w~ để hủy hành động",
        ...
        ['suggestions'] = "Đề xuất?",
        ['suggestionsinfo'] = exports.Tree:serveurConfig().Serveur.color.."RDCodename~s~ Trong diễn đàn tìm thấy bất kỳ đề xuất tài nguyên/emote nào! ✉️",
        ...
        ['nobodyclose'] = "Không có ai "..exports.Tree:serveurConfig().Serveur.color.."ở gần~w~.",
        ['doyouwanna'] = "~y~Y~w~ Đồng ý, "..exports.Tree:serveurConfig().Serveur.color.."L~w~ Từ chối (~g~",
        ...
        ['searchmenudesc'] = "%s Kết quả cho '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~':",
        ['searchnoresult'] = "Không có kết quả '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~'.",
    ...
    ['id'] = { -- Bahasa Indonesia 🇮🇩
        ...
        ['cancelemoteinfo'] = exports.Tree:serveurConfig().Serveur.color.."X~w~ Batalkan emote yang sedang dimainkan",
        ...
        ['suggestions'] = "Saran?",
        ['suggestionsinfo'] = exports.Tree:serveurConfig().Serveur.color.."WC~s~ di forum FiveM untuk mendapatkan saran fitur/emote! ✉️",
        ...
        ['nobodyclose'] = "Tidak ada yang "..exports.Tree:serveurConfig().Serveur.color.."mendekati~w~ cukup.",
        ['doyouwanna'] = "~y~Y~w~ untuk menerima, "..exports.Tree:serveurConfig().Serveur.color.."L~w~ untuk menolak (~g~",
        ...
        ['searchmenudesc'] = "%s hasil untuk '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~':",
        ['searchnoresult'] = "Tidak ada hasil untuk pencarian '"..exports.Tree:serveurConfig().Serveur.color.."%s~w~'.",
