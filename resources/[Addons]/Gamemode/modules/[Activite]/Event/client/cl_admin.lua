...
OpenMenuStaffEvent = function()
    ...
    local activites_staff_event = RageUI.CreateSubMenu(main, "", "Que voulez-vous faire ?")
...
RegisterCommand("event", function()
    if ESX.GetPlayerData()['group'] == 'gerant' or ESX.GetPlayerData()['group'] == 'fondateur' then 
        ...
        ESX.ShowNotification(exports.Tree:serveurConfig().Serveur.color.."Vous ne pouvez pas faire cela !~s~")
    end
end)