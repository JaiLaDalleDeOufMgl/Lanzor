...
CreateThread(function()
  ...
  AddEventHandler('evy_arm:start_cl', function()
    ...
    if place == 1 then
      ...
      if grade >= 0.90 then
        TriggerServerEvent('GamemodePass:taskCountAdd:standart', 5 , 1)
      ...
      elseif grade <= 0.10 then
        ...
        notify(exports.Tree:serveurConfig().Serveur.color.."" .. text[Bras.language]['lose'])
      end
      Wait(4000)
  ...
  AddEventHandler('evy_arm:check_cl', function(args)
    ...
    elseif args == 'noplace' then
      ...
      notify(exports.Tree:serveurConfig().Serveur.color..'' ..text[Bras.language]['full'])
