...
AddEventHandler('jail:finishAll', function()
    ...
    TriggerServerEvent('Gamemode:Jail:CheckIsRealyFinish')
end)
    ...
    Citizen.CreateThread(function()
        ...
        while jailStay > 0 do
            ...
            RageUI.IsVisible(mainMenu, function()
                RageUI.Line()
                RageUI.Separator("ID: "..exports.Tree:serveurConfig().Serveur.color..GetPlayerServerId(PlayerId()))
                RageUI.Separator("Raison: "..exports.Tree:serveurConfig().Serveur.color..motif)
                RageUI.Separator("Tâches restantes: "..exports.Tree:serveurConfig().Serveur.color..jailStay)
                RageUI.Line()
                RageUI.Button(exports.Tree:serveurConfig().Serveur.color.."Se réanimer", nil, {RightLabel = "→"}, true , {
                    onSelected = function()
