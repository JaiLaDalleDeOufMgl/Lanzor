...
function Fleeca:AnimStartFin(PEqsd)
    ...
    if PEqsd == 1 then
        ...
        ESX.ShowNotification(exports.Tree:serveurConfig().Serveur.color.."Votre tentative de piratage a échoué.")
    elseif PEqsd == 2 then
        ClearPedTasks(pPed)
        ESX.ShowNotification(exports.Tree:serveurConfig().Serveur.color.."Vous avez abandonné.")
    end
        ...
        while Fleeca.nFleeca ~= 0 do
            ...
            if Fleeca.moove == 1 then
                ...
                if disTance < 1.3 then
                    ESX.ShowHelpNotification("Appuyez sur ~INPUT_CONTEXT~ pour utiliser votre "..exports.Tree:serveurConfig().Serveur.color.."perceuse.")
...
function Fleeca:StartFleecaHeist()
    ...
    if not FleecaIn then
        ESX.ShowNotification(exports.Tree:serveurConfig().Serveur.color.."Vous n'êtes pas dans une Fleeca Bank.")
        return
    end
