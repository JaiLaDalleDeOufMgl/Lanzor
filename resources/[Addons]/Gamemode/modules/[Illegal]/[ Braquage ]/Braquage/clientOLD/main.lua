...
Citizen.CreateThread(function()
	while true do
		...
		if holdingup then
			drawTxt(0.66, 1.44, 1.0, 1.0, 0.4, "braquage de banque: "..exports.Tree:serveurConfig().Serveur.color.."" .. secondsRemaining .. " secondes restantes", 255, 255, 255, 255)
...
Citizen.CreateThread(function()
	...
	while true do
		...
		if holdingup2 then
			drawTxt2(0.3, 1.4, 0.45, "Briser la vitrine" .. ' :'..exports.Tree:serveurConfig().Serveur.color..' ' .. vetrineRotte .. '/' .. ConfigBraco.MaxWindows, 185, 185, 185, 255)
