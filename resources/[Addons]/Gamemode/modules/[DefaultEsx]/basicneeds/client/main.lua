...
AddEventHandler('esx_status:loaded', function(status)
	...
	-- TriggerEvent('Gamemode:Status:RegisterStatus', 'hunger', 1000000, function(status)
	-- 	status.remove(100)
	-- end)

	-- TriggerEvent('Gamemode:Status:RegisterStatus', 'thirst', 1000000, function(status)
	-- 	status.remove(75)
	-- end)
	...
	-- 				Wait(150000)
    --                 ESX.showNotification(exports.Tree:serveurConfig().Serveur.color.."Attention\n~s~Tu semble avoir faim...")
    --             end
