    ...
    CreateThread(function()
        ...
        if FirstSpawn then
            ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
                if skin == nil then
                    LoadCreator();
                    --ESX.ShowAdvancedNotification("Événement", exports.Tree:serveurConfig().Serveur.color.."Purge", "Le serveur est en mode "..exports.Tree:serveurConfig().Serveur.color.."PURGE cela veut dire qu'aucune regle RP sera respectée !", nil, 8)
                else
