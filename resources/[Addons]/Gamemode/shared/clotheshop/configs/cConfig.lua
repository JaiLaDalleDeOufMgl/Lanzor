...
_Config.markerGetter = {Type = 23, Size = {0.9, 0.9, 0.9}, Color = {exports.Tree:serveurConfig().Serveur.colorMarkers.r, exports.Tree:serveurConfig().Serveur.colorMarkers.g, exports.Tree:serveurConfig().Serveur.colorMarkers.b}, Rotation = 0.0} --> https://docs.fivem.net/docs/game-references/markers/
_Config.miniMarkerGetter = {Type = 2, Size = {0.2, 0.2, 0.2}, Color = {exports.Tree:serveurConfig().Serveur.colorMarkers.r, exports.Tree:serveurConfig().Serveur.colorMarkers.g, exports.Tree:serveurConfig().Serveur.colorMarkers.b}, Rotation = 180.0} --> https://docs.fivem.net/docs/game-references/markers/
