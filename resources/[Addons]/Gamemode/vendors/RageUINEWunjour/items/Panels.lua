...
function Panels:Percentage(Percent, HeaderText, MinText, MaxText, Actions, Index)
    ...
    if (CurrentMenu ~= nil) then
        if CurrentMenu() and (Index == nil or (CurrentMenu.Index == Index)) then
            ...
            Actions(Percent, Selected, onProgressChange, active)
...
---@return nil
---@public
function Panels:ColourPanel(Title, Colours, MinimumIndex, CurrentIndex, Callback, onColorChange, Index)
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (Index == nil or (CurrentMenu.Index == Index)) then
            ...
            Graphics.Text((Title and Title or "") .. " (" .. CurrentIndex .. " of " .. #Colours .. ")", CurrentMenu.X + RageUI.Settings.Panels.Grid.Text.Top.X + (CurrentMenu.WidthOffset / 2), CurrentMenu.Y + RageUI.Settings.Panels.Grid.Text.Top.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 0, 0.35, 245, 245, 245, 255, 1)
            ...
            if (Hovered or LeftArrowHovered or RightArrowHovered) and RageUI.Settings.Controls.Click.Active then
                ...
                if (onColorChange ~= nil) then
                    onColorChange(MinimumIndex, CurrentIndex)
                end
            end
