...
function RageUIv1.staffModeDesc(title, color, components)
    if not IsPedInAnyVehicle(PlayerPedId(), false) then
        RageUIv1.drawTexts(baseX - 0.6500, baseY - (0.800) - 0.013, title, false, 0.50, { 255,250,0,  255 }, 4, 0)
        ...
        RageUIv1.drawTexts(baseX - 0.6500, baseY - 0.110, "", false, 0.7, { 255,250,0,  255 }, 4, 0)
    end
end