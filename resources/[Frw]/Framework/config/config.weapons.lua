...
Config.Weapons = {
	...
	{name = 'WEAPON_MIDASGUN', label = _U('weapon_midasgun'), components = {}},
	{name = 'WEAPON_GOLDM', label = _U('weapon_goldm'), components = {}},
	{name = 'WEAPON_REDL', label = _U('weapon_redl'), components = {}},
	{name = 'WEAPON_AKORUS', label = _U('weapon_akorus'), components = {}},
	{name = 'WEAPON_MILITARM4', label = _U('weapon_militarm4'), components = {}},
	{name = 'WEAPON_PREDATOR', label = _U('weapon_predator'), components = {}},
	{name = 'WEAPON_BLASTAK', label = _U('weapon_blastak'), components = {}},
	{name = 'WEAPON_BLASTM4', label = _U('weapon_blastm4'), components = {}},
	{name = 'WEAPON_BLACKSNIPER', label = _U('weapon_blacksniper'), components = {}},
	{name = 'WEAPON_CHAINSAW', label = _U('weapon_chainsaw'), components = {}},
	{name = 'WEAPON_DESERTPURPLE', label = _U('weapon_desertpurple'), components = {}},
	{name = 'WEAPON_REVOLVERVAMP', label = _U('weapon_revolvervamp'), components = {}},
	{name = 'WEAPON_SPIDERAK', label = _U('weapon_spiderak'), components = {}},
	{name = 'WEAPON_PUMPKIN', label = _U('weapon_pumpkin'), components = {}},
	{name = 'WEAPON_BONEPER', label = _U('weapon_boneper'), components = {}},
	{name = 'WEAPON_SIG550', label = _U('weapon_sig550'), components = {}},
	{name = 'WEAPON_REVOLVERULTRA', label = _U('weapon_revolverultra'), components = {}},
	{name = 'WEAPON_COACHGUN', label = _U('weapon_coachgun'), components = {}},
	{name = 'WEAPON_SHOTGUNK', label = _U('weapon_shotgunk'), components = {}},
	{name = 'WEAPON_VSCO', label = _U('weapon_vsco'), components = {}},
	{name = 'WEAPON_BLUERIOT', label = _U('weapon_blueriot'), components = {}},
	{name = 'WEAPON_ANCIENT', label = _U('weapon_ancient'), components = {}},
	{name = 'WEAPON_SNAKE', label = _U('weapon_snake'), components = {}},
	{name = 'WEAPON_HELL', label = _U('weapon_hell'), components = {}},
	{name = 'WEAPON_OBLIVION', label = _U('weapon_oblivion'), components = {}},
	{name = 'WEAPON_KINETIC', label = _U('weapon_kinetic'), components = {}},
	{name = 'WEAPON_TEC9M', label = _U('weapon_tec9m'), components = {}},
	{name = 'WEAPON_TEC9MF', label = _U('weapon_tec9mf'), components = {}},
	{name = 'WEAPON_TEC9MB', label = _U('weapon_tec9mb'), components = {}},
	{name = 'WEAPON_SCARSC', label = _U('weapon_scarsc'), components = {}},
	{name = 'WEAPON_SOVEREIGN', label = _U('weapon_sovereign'), components = {}},
	{name = 'WEAPON_GLOCK17', label = _U('weapon_glock17'), components = {}},
	{name = 'WEAPON_ALIEN', label = _U('weapon_alien'), components = {}},
	{name = 'WEAPON_MIDGARD', label = _U('weapon_midgard'), components = {}},
	{name = 'WEAPON_MAZE', label = _U('weapon_maze'), components = {}},
	{name = 'WEAPON_PENIS', label = _U('weapon_penis'), components = {}},
	{name = 'WEAPON_SPECIALHAMMER', label = _U('weapon_specialhammer'), components = {}},
	{name = 'WEAPON_GUARD', label = _U('weapon_guard'), components = {}},
	{name = 'WEAPON_GRAU', label = _U('weapon_grau'), components = {}},
	{name = 'WEAPON_SCAR17', label = _U('weapon_scar17'), components = {}},
	{name = 'WEAPON_M19', label = _U('weapon_m19'), components = {}},
	{name = 'WEAPON_UZILS', label = _U('weapon_uzils'), components = {}},
	{name = 'WEAPON_DESERTNIKE', label = _U('weapon_desertnike'), components = {}},
	{name = 'WEAPON_GLOCKDM', label = _U('weapon_glockdm'), components = {}},
	{name = 'WEAPON_M4BEAST', label = _U('weapon_m4beast'), components = {}},
	{name = 'WEAPON_M4GOLDBEAST', label = _U('weapon_m4goldbeast'), components = {}},
	{name = 'WEAPON_HELLSNIPER', label = _U('weapon_hellsniper'), components = {}},
	{name = 'WEAPON_357', label = _U('weapon_357'), components = {}}
}
