...
function ESX.ShowNotification(msg, flash, saveToBrief, hudColorIndex, title, subject, icon,time,location)
    if title == nil then title = exports.Tree:serveurConfig().Serveur.label end
	...
	exports[exports.Tree:serveurConfig().Serveur.hudScript]:onAddNotification(subject, msg, 'info', time)
end 
...
function ESX.ShowHelpNotification(msg,time,location)
	...
	exports[exports.Tree:serveurConfig().Serveur.hudScript]:onSetHelpNotif(msg)
end 
