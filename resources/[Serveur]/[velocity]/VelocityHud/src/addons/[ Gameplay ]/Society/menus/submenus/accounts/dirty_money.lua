        ...
        Items:Button("Déposer de l'argent sale", nil, {
            ...
            onSelected = function()
                ...
                if (API_Player:InputIsValid(amount, "number") and tonumber(amount) > 0) then
                    ...
                    if (newAmount > 0) then
                        TriggerServerEvent('Gamemode:Society:AddMoney', MOD_Society.data.name, newAmount, "dirty_money")
                    else
        ...
        Items:Button("Retirer de l'argent sale", nil, {
            ...
            onSelected = function()
                ...
                if (API_Player:InputIsValid(amount, "number") and tonumber(amount) > 0) then
                    ...
                    if (newAmount > 0) then
                        TriggerServerEvent('Gamemode:Society:RemoveMoney', MOD_Society.data.name, newAmount,
                            "dirty_money")
                    else
                        ESX.ShowNotification("Entré invalide.")
                    end
