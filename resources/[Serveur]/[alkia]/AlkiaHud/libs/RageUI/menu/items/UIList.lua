    ...
    if CurrentMenu ~= nil then
        if CurrentMenu then
            ...
            if CurrentMenu.Pagination.Minimum <= Option and CurrentMenu.Pagination.Maximum >= Option then
                ...
                local ListText = (type(Items[Index]) == "table") and string.format("← %s%s~s~ →", "purple", Items[Index].value) or string.format("← %s%s~s~ →", "purple", Items[Index]) or "undefined"
                ...
                if Enabled == true or Enabled == nil then
                    if Selected then
                        ...
                        ListText = (type(Items[Index]) == "table") and string.format("← %s%s~s~ →", "purple", Items[Index].value) or string.format("← %s%s~s~ →", "purple", Items[Index]) or "undefined"
