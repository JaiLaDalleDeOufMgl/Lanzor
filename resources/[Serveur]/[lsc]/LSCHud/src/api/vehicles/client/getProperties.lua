...
function API_Vehicles:getProperties(vehicle)
    print("fonction 1")
    if DoesEntityExist(vehicle) then
        ...
        return {
            ...
            tyreBurst = tyreBurst,
            plate = API_Maths:trim(GetVehicleNumberPlateText(vehicle)),
            plateIndex = GetVehicleNumberPlateTextIndex(vehicle),

            bodyHealth = API_Maths:round(GetVehicleBodyHealth(vehicle), 1),
            engineHealth = API_Maths:round(GetVehicleEngineHealth(vehicle), 1),
            tankHealth = API_Maths:round(GetVehiclePetrolTankHealth(vehicle), 1),

            fuelLevel = API_Maths:round(GetVehicleFuelLevel(vehicle), 1),
            dirtLevel = API_Maths:round(GetVehicleDirtLevel(vehicle), 1),
            color1 = colorPrimary,
